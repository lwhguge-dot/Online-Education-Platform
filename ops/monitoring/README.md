...
- **账号/密码来源**: `.env` 中的 `GRAFANA_ADMIN_USER` 与 `GRAFANA_ADMIN_PASSWORD`
- **功能**: 可视化仪表盘、告警配置
...
### Prometheus 配置
- **位置**: `ops/monitoring/prometheus/prometheus.yml`
- **抓取间隔**: 15秒
- **监控目标**: 所有微服务的 `/actuator/prometheus` 端点

### Grafana 配置
- **数据源**: `ops/monitoring/grafana/provisioning/datasources/prometheus.yml`
- **仪表盘**: `ops/monitoring/grafana/provisioning/dashboards/`
