...
description: "Use when designing new API endpoints, securing existing APIs, or implementing authentication, rate limiting, and data protection."
---
...
```dot
digraph api_security_workflow {
    rankdir=TD;
    node [shape=box, style=filled, fillcolor="#f9f9f9"];

    start [label="API Security Review /\nEndpoint Design", shape=oval, fillcolor="#ffdce0"];
    auth [label="1. Auth & Authz\n(JWT, RBAC)", fillcolor="#e2f0cb"];
    input [label="2. Input Validation\n(Zod, Sanitization)", fillcolor="#ffebbb"];
    rate [label="3. Rate Limiting\n(Throttling, Quotas)", fillcolor="#ffb7b2"];
    data [label="4. Data Protection\n(HTTPS, Headers)", fillcolor="#c7ceea"];
    test [label="5. Security Testing\n(OWASP Top 10)", fillcolor="#fff3cd"];
    end [label="Secure API", shape=oval, fillcolor="#d4edda"];
...
### 触发条件
- Use when designing new API endpoints, securing existing APIs, or implementing authentication, rate limiting, and data protection.
