...
class GlobalExceptionHandlerTest {
    ...
    void shouldExtractTraceIdFromTraceParent() {
        ...
        ResponseEntity<Result<String>> response = handler.handleException(new Exception("boom"), request);
    ...
    void shouldPreferExplicitTraceIdHeader() {
        ...
        ResponseEntity<Result<String>> response = handler.handleException(new RuntimeException("business"), request);
        Result<String> result = response.getBody();
