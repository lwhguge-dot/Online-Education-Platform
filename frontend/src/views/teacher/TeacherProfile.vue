...
<template>
  <div class="space-y-6 animate-fade-in">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <!-- P1 第二批：教师资料首屏卡片入场时长压缩 -->
      <GlassCard class="p-6 col-span-2 card-hover-glow stagger-item" overflow="visible" style="--stagger-delay: 0s;">
        ...
        <div class="flex flex-col md:flex-row gap-8">
          ...
          <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-1.5 stagger-item" style="--stagger-delay: 0.2s;">
            ...
            <div class="space-y-1.5 stagger-item" style="--stagger-delay: 0.25s;">
      ...
      <div class="space-y-6">
        <GlassCard class="p-6 card-hover-glow stagger-item" style="--stagger-delay: 0.2s;">
